            ...
            <div className="relative h-48 md:h-56 bg-gradient-to-br from-primary/20 via-primary/10 to-background overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <motion.div
                  ...
                  className="w-32 h-32 rounded-full border-2 border-primary/20 relative"
                >
              ...
              <div className="grid grid-cols-3 gap-2 mb-5">
                {[
                  ...
                  <motion.div
                    ...
                    className="flex flex-col items-center gap-1 p-2.5 rounded-xl bg-muted/50 hover:bg-primary/5 cursor-pointer transition-colors"
                  >
