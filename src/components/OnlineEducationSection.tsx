          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
              ...
              <div className="p-5 md:p-6">
                ...
                <Button className="w-full rounded-xl bg-accent text-accent-foreground hover:bg-accent/90" onClick={handleOnlineClick}>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
              ...
              <div className="p-5 md:p-6">
                ...
                <Button className="w-full rounded-xl gradient-primary text-primary-foreground" onClick={handleAbroadClick}>
